...
public class NiceSpinner extends AppCompatTextView {
    ...
    private ViewDelegate viewDelegate = null;
    ...
    public <T> void attachDataSource(@NonNull List<T> list) {
        adapter = new NiceSpinnerAdapter<>(
                new DefaultAdapterDelegate<>(list),
                new DefaultViewDelegate<T>(
                        getContext(),
    ...
    public void setAdapter(ListAdapter adapter) {
        this.adapter = new NiceSpinnerAdapter<>(
                new WrapperAdapterDelegate(adapter),
                new DefaultViewDelegate<Object>(
                        getContext(),
                        spinnerTextFormatter,
                        textColor,
                        backgroundSelector,
    ...
    public void setListEntryViewDelegate(ViewDelegate viewDelegate) {
